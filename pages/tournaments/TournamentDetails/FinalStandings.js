...
export default function FinalStandings({ standings, getPlayerName }) {
  console.log("👑 Standings:", standings);
  console.log("🧍 Player Names:", getPlayerName);
    ...
    <div className="bg-white shadow-md rounded-lg p-6 mt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        <div className="border-l-4 border-yellow-400 pl-4 py-2 bg-yellow-50 rounded">
          ...
          <div className="text-gray-800">{getPlayerName(standings["1"])}</div>
        </div>
        <div className="border-l-4 border-gray-400 pl-4 py-2 bg-gray-100 rounded">
          ...
          <div className="text-gray-800">{getPlayerName(standings["2"])}</div>
        </div>
        {standings["3"] && (
          <div className="border-l-4 border-orange-400 pl-4 py-2 bg-orange-50 rounded">
            ...
            <div className="text-gray-800">{getPlayerName(standings["3"])}</div>
          </div>
        )}
        {standings["4"] && (
          <div className="border-l-4 border-blue-400 pl-4 py-2 bg-blue-50 rounded">
            ...
            <div className="text-gray-800">{getPlayerName(standings["4"])}</div>
          </div>
        )}
      </div>
    </div>
